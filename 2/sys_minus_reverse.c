...
asmlinkage long sys_minus_reverse(char __user *left, char __user *right, char __user *result, size_t left_len, size_t right_len)
{
...
SYSCALL_DEFINE5(minus_reverse, char __user *, left, char __user *, right, char __user *, result, size_t, left_len, size_t, right_len)
{
return sys_minus_reverse(left, right, result, left_len, right_len);
}
